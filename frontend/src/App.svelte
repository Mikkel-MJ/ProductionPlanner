<script async script lang="ts">
  ...
  onMount(async () => {
    auth0Client = await auth;

    isAuthenticated.set(await auth0Client.auth0.isAuthenticated());
    user.set(await auth0Client.auth0.getUser());
  });
</script>
...
<div>
  <nav>
    ...
    <ul>
      ...
      <li><a href="/#/template">Create templates</a></li>
      {#if $isAuthenticated}
